...
echo "$(curl http://localhost:8090/base)" >> /etc/yum.repos.d/CentOS-$release-BaseOS.repo

# append app_stream for aliyun
echo "$(curl http://localhost:8090/stream)" >> /etc/yum.repos.d/CentOS-$release-AppStream.repo
